            ...
            <tbody>
              {expenseList.map((expense, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{expense.date ? <TextFormat type="date" value={expense.date} format={APP_LOCAL_DATE_FORMAT} /> : null}</td>
                  <td>{expense.notes}</td>
                  <td>{expense.createdAt ? <TextFormat type="date" value={expense.createdAt} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{expense.user ? expense.user.id : ''}</td>
                  <td>{expense.category ? <Link to={`/category/${expense.category.id}`}>{expense.category.id}</Link> : ''}</td>
